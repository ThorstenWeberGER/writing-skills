...
NON_LITERAL = {
    ...
    "rather than simply": ("fragment; bare 'rather than' is a legitimate comparative. The\n                           tell is the invented-contrast frame, checked separately"),
...
RULE_ANCHORS = {
    ...
    "house-voices.md": [
        ...
        ("1 per 38-61 words", "FT attribution rate -> attribution=(30, 70)"),
        ("always spelled out, never", "per cent -> percent_spelled=True"),
        ("headline is not register-bound",
