...
This reference is based on [Wikipedia: Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing), maintained by WikiProject AI Cleanup, via [github.com/blader/humanizer](https://github.com/blader/humanizer) (MIT license). Its patterns come from reviews of AI-generated text on Wikipedia.
