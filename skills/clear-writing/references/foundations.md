...
1. **Familiar words over unfamiliar ones.** The real rule is familiarity, not length: "utilize" is bad because it's unusual, not because it's long, and a long familiar word beats a short obscure one. Federal guidance puts it as picking the commonly used word over the unusual or obscure. Worst repeat offenders: *utilize, commence, implement, assist, promulgate, in accordance with, in order that, in the event of, in the amount of*. Two further families come from Garner by way of proselint (BSD): dead business-letter formulas, *in regard to, acknowledging yours of, beg to advise, enclosed herewith, enclosed please find, further to your letter, further to yours of, per your order, per your request*, and nouns turned into verbs, *agendize, disincentivize, in the affirmative, in the negative*.
...
- **HBR is now primary, and it exposed three defects in our own checker.** Five articles measured: three magazine features, one digital article, and one curated-tips list. 14,557 words, 665 sentences.
  ...
  **Two more checker defects, both false positives:**
  ...
  - **Buzzwords flagged in literal use.** "circle back" fired on "they circle back with all stakeholders", in a sentence about the aftermath of a decision, where it carries its plain meaning. Left as a FAIL deliberately: unlike the AI-tell list, `BUZZWORDS` is **prescriptive, not descriptive:** it records words we choose to avoid, not words professionals avoid. HBR uses "circle back" and "actionable"; that is worth knowing and does not by itself make them good choices. The plain-language argument stands on its own.
