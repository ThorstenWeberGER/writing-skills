...
**4. Report what you ran, not that you applied something.** "Ran the checker: 0 FAIL, 1 REVIEW (passive in *are affected*, kept under the actor-irrelevant exception)" is auditable. "Applied the clear-writing skill" is not, and that phrasing is exactly what let unenforced steps go unnoticed. If you could not verify something, say so instead of asserting it is clean.
